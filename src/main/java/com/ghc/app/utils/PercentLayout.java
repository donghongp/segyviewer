...
/**
 * PercentLayout. <BR>
 * Constraint based layout which allow the space to be splitted using percentages. The
 * following are allowed when adding components to container:
 * <ul>
 ...
 * in this case, the component will have a width (or height) of 25 % of the container
 * width (or height) <br>
 * <li>container.add(component, "*"); <br>
 * in this case, the component will take the remaining space. if several components use
 * the "*" constraint the space will be divided among the components.
 * </ul>
 *
 * @javabean.class name="PercentLayout" shortDescription="A layout supports constraints
...
public class PercentLayout implements LayoutManager2 {
	...
	public void layoutContainer(Container parent) {
		...
		int totalSize = (HORIZONTAL == orientation ? d.width : d.height)
